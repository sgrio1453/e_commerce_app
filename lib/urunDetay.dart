...
import 'package:e_ticaret/sayfa/grafik.dart';
                  ...
                  Row(
                    ...
                    children: [
                      SafeArea(
                        ...
                        child: baslik(widget.urunBaslik, context),
                      )),
                    ],
                  ),
                  SizedBox(height: 32),
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "${urunToplamHesapla(popurun.miktar.toInt(), 1300)} \₺",
...
class GrafikApple extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => GrafikAppleState();
}

class GrafikAppleState extends State {
  int touchedIndex = -1;
