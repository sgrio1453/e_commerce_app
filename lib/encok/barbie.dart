...
class GrafikBarbie extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => GrafikBarbieState();
}

class GrafikBarbieState extends State {
  int touchedIndex = -1;
