              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "${urunToplamHesapla(popurun.miktar.toInt(), 1000)} \₺",
...
class GrafikHediye extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => GrafikHediyeState();
}

class GrafikHediyeState extends State {
  int touchedIndex = -1;
                ...
                Row(
                  children: [
                    Indicator(
                      ...
                      text: 'Zam geleceği için eklenmiş fiyat',
                      isSquare: false,
