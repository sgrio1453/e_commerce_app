              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      "${urunToplamHesapla(popurun.miktar.toInt(), 250)} \₺",
...
class GrafikAycicek extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => GrafikAycicekState();
}

class GrafikAycicekState extends State {
  int touchedIndex = -1;
